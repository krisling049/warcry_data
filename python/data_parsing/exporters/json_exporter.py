...
Provides module-level functions for exporting warband data to various JSON formats.
"""
...
from ..config import AbilityCosts, SpecialWarbands, DataTypes
from ..fighters import sort_fighters
from ..io import write_data_json, sanitise_filename

logger = logging.getLogger(__name__)


def export_fighters(fighters_data: List[Dict[str, Any]], dst: Path) -> None:
...
def export_abilities(abilities_data: List[Dict[str, Any]], dst: Path,
...
def export_battletraits(abilities_data: List[Dict[str, Any]], dst: Path) -> None:
...
def export_warbands_structure(fighters_data: List[Dict[str, Any]],
...
def export_localized_data(abilities_data: List[Dict[str, Any]],
